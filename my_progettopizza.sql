...
--
-- Host: localhost
-- Generation Time: Mag 23, 2018 alle 23:53
...
(13, 'Rucola', 5.40, 'Pizza', 'mozzarella, pomodoro, rucola'),
...
CREATE TABLE IF NOT EXISTS `ordini` (
  ...
  `costo_tot` int(255) NOT NULL,
  `data_ora` varchar(255) NOT NULL,
  `stringaOrdine` varchar(65000) NOT NULL,
  PRIMARY KEY (`codice`)
...
INSERT INTO `ordini` (`codice`, `asporto`, `costo_tot`, `data_ora`, `stringaOrdine`) VALUES
(42708553, 0, 440, '23/05/2018_21:02:39', '2,'),
(73806105, 0, 340, '23/05/2018_23:33:04', '1,'),
(92962443, 0, 3500, '19/05/2018_21:33:05', '153,153,153,153,153,153,153,153,153,153,');
...
('Paolo', 'Brosio', 'paolobrosio@gmail.co', 'PaoloBrosio666', '969044ea4df948fb0392308cfff9cdce');
